/* =========================================================================
  ...
  function computeKpis(data) {
    ...
    return {
      total, done, inProgress, emAprovacao, emValidacao, aguardandoInsumos,
      pending, blocked, highImpact, highPriority, pct,
    };
  }
  ...
  function computeStatusDistribution(data) {
    const order = ['Concluído', 'Em andamento', 'Em aprovação', 'Em validação', 'Aguardando insumos', 'Pendente', 'Bloqueado'];
  ...
  function computeCriticalActions(data) {
    ...
    return { total, done, pct, byStatus, items };
  }
